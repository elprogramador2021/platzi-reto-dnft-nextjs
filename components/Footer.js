...
const Footer = () => {
    return (
        <div className="p-2 bg-black">
            <footer className=" bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-black">
                <span className="text-sm text-slate-200 sm:text-center dark:text-slate-200">
                    <a href="https://flowbite.com/" className="hover:underline flex items-center">
                        <IoMdFlower size={26} />
                        platziretoDNFT - 2022
                    </a>
                </span>
